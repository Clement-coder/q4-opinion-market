...
export default function LoginPage() {
  ...
  // Detect returning user — set by SignUpPage on first successful sign-in
  const isReturning = localStorage.getItem("q4_has_signed_in") === "1";
      ...
      <div className="auth-inner">
        ...
        <div className="auth-card">
          <h1 className="mb-2 text-lg font-semibold text-white">
            {isReturning ? "Welcome Back" : "Log In"}
          </h1>
          ...
          >
            ...
            {loading ? "Signing in…" : isReturning ? "Sign in with Google" : "Continue with Google"}
          </button>
