...
import { Mail, Lock, Eye, EyeOff, ArrowRight, ShieldCheck, Q4Logo } from "../components/icons";

/**
 * LoginPage
 *
 * Auth integration point:
 * Replace handleGoogleLogin with actual Google OAuth flow.
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm" style={{ color: "rgba(255,255,255,0.4)" }}>
            Welcome back. Time to stake your conviction.
          </p>
        </div>

        <div className="auth-card">
          <h1 className="mb-5 text-lg font-semibold text-white">Log In</h1>
          ...
          <button
            ...
            style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", color: "rgba(255,255,255,0.8)", borderRadius: 6 }}
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                ...
                <Link to="/" className="text-xs transition" style={{ color: "rgba(255,255,255,0.35)" }}
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type={show ? "text" : "password"} required placeholder="Your password" value={form.password} onChange={update("password")} className="input-field" style={{ paddingLeft: 36, paddingRight: 40 }} />
                <button type="button" onClick={() => setShow(!show)} className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: "rgba(255,255,255,0.3)" }} aria-label="Toggle password">
        ...
        <p className="mt-5 text-center text-sm" style={{ color: "rgba(255,255,255,0.35)" }}>
          ...
          <Link to="/signup" className="font-medium" style={{ color: "rgba(255,255,255,0.7)" }}
